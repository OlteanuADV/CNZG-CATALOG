        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-body text-center">
                    ...
                    elseif($user->InSchoolFunction == 1) if($class !== 0)
                    <span class="badge badge-info">Profesor de '.App\Subjects::find($user->Subject)->Name.' si diriginte la clasa '.$class->Number.' '.$class->Character.'</span>
                    <span class="badge badge-info">Profesor de '.App\Subjects::find($user->Subject)->Name.'</span>
                </div>
            </div>
